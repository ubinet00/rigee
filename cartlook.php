...
if (isset ( $_SESSION ['cart'] ) and count($_SESSION['cart'])!=0) {
	...
	echo '<table border="1"><tr><td>img</td><td>name</td><td>model</td><td>price</td><td>price2</td><td>kazu</td><td>delete</td></tr>';
	...
	for($i = 0; $i < count ( $cart ); $i ++) {
		...
		echo '<tr><td><img src="./rigee-bicycle/'.$rec['img'].'"><td>' . $rec ['name'] . '</td><td>' . $rec ['model'] . '<td>' . $rec ['price'] . '</td><td>' . $rec ['price2'].'</td>
	...
	echo '</table></form>';
	echo '<a href="shop_form.php">go shop</a>';
